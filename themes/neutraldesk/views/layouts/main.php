        ...
        <div class="header_resize" >
            ...
            <div class="search">
                <form id="form1" name="form1" method="post" action="#">
                    ...
                    <input name="b" type="image" src="<?php echo Yii::app()->theme->baseUrl; ?>/images/search.gif" class="button" />
                </form>
            </div>
            <div class="clr"></div>
            <div class="menu">
        ...
        <div class="headert_text_resize">
            <div class="textarea">
                <h2><strong>DO YOU NEED</strong> A NEW DESIGN?<br />
                    ...
                    <a href="#"><img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/view_ga.gif" alt="" width="206" height="47" border="0" /></a>
            </div>
            <img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/img_main.jpg" alt="" width="445" height="284" />
            <div class="clr"></div>
        </div>
    </div>
